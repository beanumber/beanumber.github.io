...
- Tuesdays from 2:45 pm -- 4:00 pm ET in McConnell 214
- Fridays from 10:00 am -- 11:30 am [via Zoom](https://smith.zoom.us/j/98675937227) 
...
In the past `r summarize(teaching, n_distinct(year))` years, I've taught `r nrow(teaching)` courses over `r summarize(teaching, n_distinct(year, semester))` semesters. 
